...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*PluginConfig)(nil), (*api.PluginConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
...
// Convert_v1alpha2_PluginConfig_To_api_PluginConfig is an autogenerated conversion function.
func Convert_v1alpha2_PluginConfig_To_api_PluginConfig(in *PluginConfig, out *api.PluginConfig, s conversion.Scope) error {
	return autoConvert_v1alpha2_PluginConfig_To_api_PluginConfig(in, out, s)
}
