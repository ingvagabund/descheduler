...
func nodeAvailableResources(nodeIndexer podutil.GetPodsAssignedToNodeFunc, node *v1.Node, resourceNames []v1.ResourceName, podUtilization utils.PodUtilizationFnc) (map[v1.ResourceName]*resource.Quantity, error) {
...
func NodeUtilization(pods []*v1.Pod, resourceNames []v1.ResourceName, podUtilization utils.PodUtilizationFnc) (map[v1.ResourceName]*resource.Quantity, error) {
